...
3. **真 takeaway 是效率,且在最难处最明显**:gpt-oss-20b(仅 **3.6B 激活**)在加难任务上**夺冠**——4步满分、5步 0.90——以约 1/4 的 per-token 算力击败 dense 的 14B。那道拦住 dense 模型的深度墙,MoE+reasoning 几乎没撞上。**单位激活算力下最强的长链 agent 可靠性。**
