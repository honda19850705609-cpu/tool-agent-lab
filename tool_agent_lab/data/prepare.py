...
ungated alternative via --dataset, or use --source synthetic / modelscope.)
...
Run:
  python -m tool_agent_lab.data.prepare --model <base> --out data/sft_train.jsonl --n 20000
"""
...
def main():
    ...
    ap.add_argument("--dataset", default="AI-ModelScope/xlam-function-calling-60k",
