...
This lets eval/eval_agent.py score gpt-oss by EXECUTION (did the task get solved)
on the exact same multi-step tasks as Qwen — an apples-to-apples agent compare.
...
def run_harmony(model, tok, query, tool_schemas, call_tool, max_steps=6, max_new=512):
    ...
    final answer (no tool call). Returns (final_text, trace) like agent.runtime.Agent.run."""
